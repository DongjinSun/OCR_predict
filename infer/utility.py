...
def init_args():
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="./utils/dict/korean_dict.txt")
    parser.add_argument("--use_space_char", type=str2bool, default=True)
    parser.add_argument(
        "--vis_font_path", type=str, default="./korean.ttf")
    ...
    parser.add_argument(
        "--e2e_char_dict_path", type=str, default="./utils/ic15_dict.txt")
...
def create_font(txt, sz, font_path="./korean.ttf"):
    font_size = int(sz[1] * 0.70)
    font = ImageFont.truetype(font_path, font_size, encoding="utf-8")
    length = 0 #font.getsize(txt)[0]
    if length > sz[0]:
